...
contract('MetaCoin', function(accounts) {
  ...
  it("should allow owner to mint coins", function() {
    ...
    return MetaCoin.deployed().then(function(instance) {
      ...
      account_one_starting_balance = balance.toNumber();
      return meta.mint(amount, {from: account_one});
    }).then(function() {
      return meta.getBalance.call(account_one);
    }).then(function(balance) {
      account_one_ending_balance = balance.toNumber();
      
	  assert.equal(account_one_starting_balance+amount, account_one_ending_balance, "Amount wasn't correctly minted to the owner");
    });
